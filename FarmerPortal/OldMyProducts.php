...
<body>
     ...
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;">@FarmGo</a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">FarmGo6@gmail.com</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.FarmGo.com</h5>
     </div>
